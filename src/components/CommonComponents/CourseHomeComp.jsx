...
import { Accordion, ActionIcon, BackgroundImage, Box, Button, Card, Center, Container, CopyButton, Divider, Flex, Grid, Group, Image, Loader, Modal, Overlay, Radio, Space, Spoiler, Tabs, Text, Tooltip, UnstyledButton } from '@mantine/core'
                    ...
                    <Box>
                        <Box>
                            <Grid>
                                            ...
                                            <Tabs.Panel value='overview'>
                                                <Card style={{ paddingLeft: "1rem" }}>
                                                    ...
                                                    <Group style={{ display: "flex", alignItems: "center" }} >
                                                        ...
                                                        <Text color="#3A3A3A" fz={10} style={{ display: "flex", alignItems: "center" }}> <BsDot /> </Text>
                                ...
                                <Grid.Col span={4}>
                                    <Container pl={0} pr={0} fluid style={{ backgroundColor: "#3A3A3A" }}>

                                        <Text color="#FFFFFF" pb={10} p={20} fw={400} fz={22}>Contents</Text>
                                        <Divider className='divider' style={{ borderTopColor: null }} />

                                        <Card pt={0} pb={0} style={{ backgroundColor: "#3A3A3A" }} >
                                            <Accordion defaultValue={"material"} chevron={<IoChevronDown color='#FFFFFF' />}>
                                                <Accordion.Item className='accordiancomp' value='material'>
                                                    <Accordion.Control className='accbtn' ><Text fz={16} color='#FFFFFF'>Materials</Text></Accordion.Control>
                                                    <Accordion.Panel  >
                                                            ...
                                                            <div>
                                                                {
                                                                    ...
                                                                    lessonData.map((lesson, index) => {
                                                                        ...
                                                                        return <Text fz={14} color='#FFFFFF' key={lesson.lesson_id}>{extracted}</Text>;
                                                                    })
                                                                }
                                                                            ...
                                                                            return (
                                                                                <Tooltip label="View Document">
                                                                                    <ActionIcon variant='transparent' onClick={() => openNewTab(materialUrl)}>
                                                                                        <MdDocumentScanner size={22} color='grey' />
                                                                                    </ActionIcon>
                                                                                </Tooltip>
                                                                            )
                                                ...
                                                <Accordion.Item value='clipboard' className='accordiancomp'>
                                                    <Accordion.Control className='accbtn' ><Text fz={16} color='#FFFFFF'>Clipboard</Text></Accordion.Control>
                                                            ...
                                                            lessonData.map((lesson) => {
                                                                ...
                                                                if (lesson.clipboards) {
                                                                    ...
                                                                    // return <Text id='txt' color='#FFFFFF' key={lesson.lesson_id}>Back to Basics</Text>;
                                                                            ...
                                                                            <Text fz={14} id='txt' color='#FFFFFF' key={index}>{item}</Text>
                                                                        ...
                                                                        <div key={index}>
                                                                            <Tooltip label={copiedIndex === index ? 'Copied' : 'Copy to Clipboard'} withArrow>
                                                                                <ActionIcon variant="transperant" onClick={() => {
                                                                                    ...
                                                                                    {copiedIndex === index ? (
                                                                                        <TiTick size={22} color={copiedIndex === index ? 'teal' : 'gray'} />
                                                                                    ) : (
                                                                                        <TbCopy size={22} color={copiedIndex === index ? 'teal' : 'gray'} />
                                                                                    )}
...

                                                            {
                                                                item.lesson_status === "locked" ?
                                                                    ...
                                                                    (
                                                                        ...
                                                                        <div style={{ cursor: "pointer" }} className={currentPlayingId === item.lesson_id ? 'selectedlesson' : ''}
                                                                                            ...
                                                                                            item.quiz_attempt_status === true ?
                                                                                                ...
                                                                                                (<Flex gap={100}>
                                                                                                    <Flex gap={5}>
                                                                                                        ...
                                                                                                        <Text fz={"xs"} c={item.quiz_score < 60 ? "red" : "rgba(0, 156, 23, 1)"}>{Math.floor(item.quiz_score)}%</Text>
                                                                                                    </Flex>
